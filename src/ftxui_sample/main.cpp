...
// configuration step. It creates a namespace called `miniature_carnival`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", miniature_carnival::cmake::project_name, miniature_carnival::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", miniature_carnival::cmake::project_version);
      return EXIT_SUCCESS;
    }
